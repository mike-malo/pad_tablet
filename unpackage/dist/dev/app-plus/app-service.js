...
/* 6 */
/*!********************************************!*\
  !*** D:/project/uniapp/pda_app/pages.json ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 9 */
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--11-0!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/filter-modules-template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!D:/project/uniapp/pda_app/pages/index/index.vue?vue&type=template&id=2be84a3c&mpType=page ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 11 */
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--7-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/using-components.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!D:/project/uniapp/pda_app/pages/index/index.vue?vue&type=script&lang=js&mpType=page ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {\n\nvar _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ 1);\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\nvar _scanCode = _interopRequireDefault(__webpack_require__(/*! ../../scanCode.vue */ 13));\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = {\n  components: {\n    scanCode: _scanCode.default\n  },\n  data: function data() {\n    return {\n      title: 'Hello',\n      code: \"\",\n      str: \"\",\n      wv: \"\",\n      url: '',\n      currentWebview: null,\n      areaTxt: ''\n    };\n  },\n  onBackPress: function onBackPress() {\n    return true;\n  },\n  onUnload: function onUnload() {\n    uni.$off('updata');\n  },\n  onLoad: function onLoad() {\n    var _this2 = this;\n    uni.$on('updata', function (data) {\n      __f__(\"log\", data, \" at pages/index/index.vue:72\");\n      _this2.url = data;\n    });\n  },\n  mounted: function mounted() {\n    // wv = this.$scope.$getAppWebview().children()[0]\n    // let info = {str: this.code}\n    // wv.evalJS(`aaa(${JSON.stringify(info)})`)\n  },\n  onReady: function onReady() {\n    // var currentwebView = this.$scope.$getAppWebview()\n    // wv = currentwebView.evaluateJavascript(\"javascript:aaa('123')\");\n    // const currentWebview = this.$parent.$scope.$getAppWebview().children()[0]\n    // currentWebview.evalJS(`test(${123})`)\n    // var height = -40;\n    // this.str = this.code\n    // const self = this\n    // var wv = self.$scope.$getAppWebview().children()[0]\n    // setTimeout(function() {\n    // \twv.setStyle({\n    // \t\ttop:0,\n    // \t\theight: height,\n    // \t\tscalable: false,\n    // \t})\n    // \twv.evalJS(`aaa(${JSON.stringify(self.str)})`)\n    // })\n\n    // this.wv.evalJS(`aaa(${JSON.stringify(this.str)})`)\n\n    uni.getStorage({\n      key: 'id',\n      success: function success(res) {\n        __f__(\"log\", res.data, \" at pages/index/index.vue:104\");\n        this.url = res.data;\n        __f__(\"log\", this.url, \" at pages/index/index.vue:106\");\n      }\n    });\n  },\n  onShow: function onShow() {\n    var _this = this;\n    uni.$off('scancodedate');\n    uni.$on('scancodedate', function (data) {\n      __f__(\"log\", '扫描数据： ', data.code, \" at pages/index/index.vue:116\");\n      _this.code = data.code;\n      _this.test();\n      // var that = this;\n      // let currentWebview = getCurrentPages()[0];\n      // that.wv = currentWebview.$getAppWebview();\n      // currentwebView.evaluateJavascript(\"javascript:aaa('123')\");\n    });\n\n    this.url = uni.getStorageSync('id');\n  },\n  methods: {\n    // open(){\n    // \tuni.showModal({\n    // \t    title: '提示',\n    // \t    content: '确定退出登录吗？',\n    // \t    success: function (res) {\n    // \t        if (res.confirm) {\n    // \t            console.log('用户点击确定');\n    // \t\t\t\tuni.navigateTo({\n    // \t\t\t\t\turl: '/pages/common/exit'  //点击要跳转的页面路径\n    // \t\t\t\t});\n    // \t        } else if (res.cancel) {\n    // \t            console.log('用户点击取消');\n    // \t        }\n    // \t    }.bind(this)//可处理uni.shuowModal的异步（即拿不到data里面数据的解决办法）\n    // \t});\n    // },\n    test: function test() {\n      var wv = this.$scope.$getAppWebview().children()[0];\n      wv.evalJS(\"aaa(\".concat(JSON.stringify(this.code), \")\"));\n    },\n    openWindows: function openWindows() {\n      var subNVue = uni.getSubNVueById('popup');\n      subNVue.show();\n    }\n  },\n  onNavigationBarButtonTap: function onNavigationBarButtonTap(e) {\n    var _this3 = this;\n    // let rightText = ''\n    // if (this.isEditStatus) {\n    // \trightText = '菜单'\n    // } else {\n    // \trightText = ''\n    // }\n    // this.isEditStatus = !this.isEditStatus\n    // const currentWebview = this.$mp.page.$getAppWebview();\n    // currentWebview.setTitleNViewButtonStyle(e.index, {\n    // \ttext:rightText\n    // });\n    if (e.index === 0) {\n      __f__(\"log\", \"你点击了设置页面按钮\", \" at pages/index/index.vue:170\");\n      this.openWindows();\n    } else if (e.index === 1) {\n      __f__(\"log\", \"你点击了刷新按钮\", \" at pages/index/index.vue:173\");\n      var wv = this.$scope.$getAppWebview().children()[0];\n      wv.reload(true);\n    } else if (e.index === 2) {\n      __f__(\"log\", \"你点击了扫码按钮\", \" at pages/index/index.vue:177\");\n      uni.scanCode({\n        success: function success(res) {\n          _this3.code = res.result;\n          __f__(\"log\", res.result, \" at pages/index/index.vue:181\");\n          __f__(\"log\", _this3.code, \" at pages/index/index.vue:182\");\n          var wv = _this3.$scope.$getAppWebview().children()[0];\n          wv.evalJS(\"aaa(\".concat(JSON.stringify(_this3.code), \")\"));\n        }\n      });\n    }\n  }\n};\nexports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 12)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///11\n");
...
/* 14 */
/*!*****************************************************************************!*\
  !*** D:/project/uniapp/pda_app/scanCode.vue?vue&type=template&id=30c56ad0& ***!
  \*****************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 15 */
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--11-0!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/filter-modules-template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!D:/project/uniapp/pda_app/scanCode.vue?vue&type=template&id=30c56ad0& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 19 */
/*!*****************************************!*\
  !*** D:/project/uniapp/pda_app/App.vue ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 20 */
/*!******************************************************************!*\
  !*** D:/project/uniapp/pda_app/App.vue?vue&type=script&lang=js& ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 21 */
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--7-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/using-components.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!D:/project/uniapp/pda_app/App.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
